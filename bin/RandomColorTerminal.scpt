...
global kColorScalar
set kColorScalar to 0.25

-- Choose a random color for the background
set randomRed to (random number) * (kColorValueMaximum * kColorScalar)
set randomGreen to (random number) * (kColorValueMaximum * kColorScalar)
set randomBlue to (random number) * (kColorValueMaximum * kColorScalar)
set myBackgroundColor to {randomRed, randomGreen, randomBlue, 256}
